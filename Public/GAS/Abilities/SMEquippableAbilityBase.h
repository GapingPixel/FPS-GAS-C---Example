 ...
 */
UCLASS()
class SPAWNMASTER_API USMEquippableAbilityBase : public USMGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "SpawnMaster|Ability")
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "SpawnMaster|Ability")
